...
interface Props {
  ...
  // El componente ahora espera recibir la observación del usuario
    ...
    >
      ...
      >
        ...
        <textarea
          ...
          className="w-full p-3 text-sm border border-gray-200 rounded-[10px] outline-none focus:ring-2 focus:ring-[#308C58] transition-all"
          value={obs}
