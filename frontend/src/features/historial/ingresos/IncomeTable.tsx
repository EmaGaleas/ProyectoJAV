    ...
    <div className="flex flex-col gap-4 flex-1 min-w-0">
      {loading && (
        <div
          ...
          style={{ fontSize: 12, color: '#8EBFA3' }}
        >
      ...
      <div className="flex gap-2">
        <div className="relative flex flex-1 items-center">
          ...
          <input
            ...
            className="flex-1 h-10 pl-10 pr-4 text-sm rounded-xl border border-[rgba(0,0,0,0.12)] bg-white focus:outline-none focus:ring-2 focus:ring-[#308C58] focus:ring-opacity-30"
          />
        </div>
      ...
      {/* Tabla */}
      <div className="bg-white rounded-2xl shadow-sm border border-[rgba(0,0,0,0.07)] overflow-x-auto flex flex-col">
