...
export const MOCK_BALANCE: BalanceRecord[] = [
  { id: '1', fecha: '2026-06-15', tipo: 'Ingreso', categoria: 'Mensualidad', descripcion: 'Pago Mensualidad - Bloque A Lote 5', monto: 150.00 },
  { id: '2', fecha: '2026-06-19', tipo: 'Egreso', categoria: 'Mantenimiento', descripcion: 'Compra de Tubos PVC', monto: 850.00 },
];